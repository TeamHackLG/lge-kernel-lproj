...
echo "3) L5 NFC       - E610"
echo "4) L5 NoNFC     - E612 | E617"
echo "5) L7 NFC       - P700"
echo "6) L7 NoNFC     - P705"
...
case "$choice" in
	...
	3 ) target="L5NFC-"; variant="Single"; echo "$choice - $target$variant"; make cyanogenmod_m4_defconfig &> /dev/null; maindevicecheck="On";;
